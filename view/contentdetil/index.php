	...
	<div id="Top_bar">
		<div class="container">
			<div class="column one">
				<!-- .logo -->
				<div class="logo">
					<h1><a id="logo" href="home-corporate.html" title="Cake"><img class="scale-with-grid" src="upload/logo_dark.png" alt="Cake"/></a></h1>
				</div>
				<!-- .menu_wrapper -->
				<div class="menu_wrapper">
					...
					<ul id="menu-main-menu" class="menu">
						<li class="menu-item  "><a href="home-corporate.html"><b><span>Home</span></b></a></li>
						<li class="menu-item  "><a href="tabs.html"><b><span>About Us</span></b></a></li>
						<li class="menu-item  "><a href="business.html"><b><span>Business</span></b></a></li>
						<li class="menu-item  "><a href="career.html"><b><span>Career</span></b></a></li>
						<li class="menu-item  current-menu-item current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children"><a href="med.html"><b><span>Media</span></b></a></li>
						<li class="menu-item  "><a href="contact.html"><b><span>Contact</span></b></a></li>
						...
						<div class="section_wrapper clearfix">
							...
							<div class="column one post-photo-wrapper">
								<div class="post-photo">
									<img width="1200" height="570" src="/public/upload/1-1200x570.jpg" class="scale-with-grid wp-post-image" alt="1" style="height: 413.6px;">
								</div>
							</div>
